...
| $wgDPLAllowUnlimitedCategories  | false   | Set this to true to ignore `maxCategoryCount` and allow unlimited categories. Please note that large amounts of categories in a query can slow down or crash servers.                                                          |
| $wgDPLAllowUnlimitedResults     | false   | Set this to true to ignore `maxResultCount` and allow unlimited results. Please note that large result sets may result in slow or failed page loads.                                                                         |
